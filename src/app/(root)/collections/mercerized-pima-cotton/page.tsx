...
import { mercerizedPimaCotton } from '@/app/lib/database/connections'
...
export const metadata:Metadata={
  title:'Mercerized Pima Cotton',
  description:'The Mercerized Pima Cotton Product Page',
  creator:'Julian Borner'
}
type Props = {}

const Mercerized_Pima_Cotton = (props: Props) => {
   const [filterModal,setFilterModal]=useState<any>(null);
  const {data}=useQuery({
    queryKey:['Desert_Boots'],
    queryFn:()=>mercerizedPimaCotton(),
    staleTime:1000 * 60 * 5
  })
...
export default Mercerized_Pima_Cotton 