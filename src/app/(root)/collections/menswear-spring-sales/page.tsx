...
import { menswearSpringSales } from '@/app/lib/database/connections'
...
export const metadata:Metadata={
  title:'Menswear Spring Sales',
  description:'The Menswear Spring Sales Product Page',
  creator:'Julian Borner'
}
type Props = {}

const Menswear_Spring_Sales = (props: Props) => {
   const [filterModal,setFilterModal]=useState<any>(null);
  const {data}=useQuery({
    queryKey:['Desert_Boots'],
    queryFn:()=>menswearSpringSales(),
    staleTime:1000 * 60 * 5
  })
...
export default Menswear_Spring_Sales