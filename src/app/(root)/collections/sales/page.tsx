...
const Sales = (props: Props) => {
    ...
    if(data!=undefined) console.log(data)
      if(data!=undefined) console.log(data?.data?.data)
  return (
    <div className='bg-white text-black' >
        ...
        <div className='w-full' >
         <div className='flex justify-between p-8 ' >
           <h1 className='' >{data && data?.data?.data?.length} items</h1>
         ...
         <div className='flex flex-wrap self-center w-full p-2 gap-x-8 md:justify-center ' >
            {data!=undefined && data?.data?.data?.map((items:any)=>
