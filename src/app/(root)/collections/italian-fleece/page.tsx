...
import { getShoeFavorites } from '@/app/lib/database/connections'
import { getFullGrainLeather } from '@/app/lib/database/connections'
import { italianFleece } from '@/app/lib/database/connections'
...
export const metadata:Metadata={
  title:'Italian Fleece',
  description:'The Italian Fleece Product Page',
  creator:'Julian Borner'
}
type Props = {}

const Italian_Fleece = (props: Props) => {
   const [filterModal,setFilterModal]=useState<any>(null);
  const {data}=useQuery({
    queryKey:['Desert_Boots'],
    queryFn:()=>italianFleece(),
    staleTime:1000 * 60 * 5
  })
