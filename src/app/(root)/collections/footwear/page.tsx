    ...
    <div className='bg-white text-black' >
        ...
        <div className='relative absolute' >
            ...
            <h1 className=' relative  justify-self-center self-center text-xl text-white z-100 top-56 ' >Footwear</h1>
              {AllData!=undefined && <Image className=' w-full   overflow-hidden z-100  -top-12 ' width={1500} height={1500} src={AllData?.data?.data[9]?.images[0]} quality={100} alt='footwear-banner' />} 
        ...
        <div className='w-full' >
         ...
         <div className='flex flex-wrap self-center max-sm:justify-center  w-full p-2 gap-x-8' >
